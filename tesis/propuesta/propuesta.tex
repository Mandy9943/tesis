...
\begin{figure}[h!]
    \centering
    \insertimageboxed[\label{fig:login}]{inicioSesion}{scale=0.3}{0}{Pantalla de inicio de sesión del sistema SCADA propuesto.}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \insertimageboxed[\label{fig:adminUsuarios}]{adminUsuarios}{scale=0.3}{0}{Interfaz de la sección de gestión de usuarios del sistema SCADA propuesto.}
\end{figure}

\subsection{Monitoreo del proceso}

El proceso de ósmosis inversa con electrodesionización, se presenta en la interfaz del SCADA como una vista detallada, que refleja la operación del sistema en tiempo real. Esta vista permite al usuario interactuar y obtener información detallada de los componentes del sistema, como modelo, fabricante, entre otras características. Para acceder a estos detalles, el usuario simplemente puede hacer clic en el componente deseado.

La Figura \ref{fig:osmosis_inversa} ilustra la interfaz de la vista de proceso de ósmosis inversa.

\begin{figure}[h!]
    \centering
    \insertimageboxed[\label{fig:osmosis_inversa}]{monitoreoProceso1}{scale=0.3}{0}{Interfaz de la vista del proceso de ósmosis inversa.}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \insertimageboxed[\label{fig:componente}]{caracteristicas}{scale=0.3}{0}{Interfaz de las características del componente.}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \insertimageboxed[\label{fig:parametros}]{parametros}{scale=0.3}{0}{Interfaz de la sección de configuración de parámetros.}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \insertimageboxed[\label{fig:ventana_alarmas}]{adminAlarmas1}{scale=0.3}{0}{Ventana emergente de alarmas.}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \insertimageboxed[\label{fig:seccion_alarmas}]{adminAlarmas2}{scale=0.3}{0}{Interfaz de la sección de alarmas.}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \insertimageboxed[\label{fig:historial_alarmas}]{adminAlarmas3}{scale=0.3}{0}{Interfaz del historial completo de alarmas.}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \insertimageboxed[\label{fig:graficos_historicos}]{graficosHistoricos1}{scale=0.3}{0}{Interfaz de la sección de gráficos históricos.}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \insertimageboxed[\label{fig:generacion_informes}]{informe}{scale=0.3}{0}{Interfaz de la generación de informes.}
\end{figure}
