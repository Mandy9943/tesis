...
\subsubsection{Sensores de conductividad}
...
\insertimageboxed[\label{fig:sensorCLS164D1A1R}]{instrumentacion/sensorCLS16}{scale=0.7}{0}{Sensor de conductividad CLS16-4D1A1R}
...
% ------------Sensores de Presion-----------
\subsubsection{Sensores Transmisores de Presión}
...
\insertimageboxed[\label{fig:sensor_transmisor_presion}]{instrumentacion/sensor_transmisor_presion}{scale=0.8}{0}{Sensor-Transmisor de presión PTP31-A1C13S1AF1A}
