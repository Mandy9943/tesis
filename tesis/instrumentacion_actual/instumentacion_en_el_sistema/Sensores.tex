...
En nuestro sistema el sensor de conductividad usado como el de la figura \ref{fig:sensorCLS16}, pertenece al fabricante Endress+Hauser, y tiene un principio de funcionamiento que radica en la medición de la
...
\begin{mytable}{6cm}{Características del sensor de edox CPS12D-7PA21.}{table:sensor_redox}
...
inicie sólo cuando el nivel de agua en el tanque alcanza un punto establecido, lo que contribuye a optimizar la eficiencia del proceso.
...
del sistema y transmitir esa información a un sistema de control para su seguimiento y análisis. El empleado
