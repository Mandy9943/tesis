...
\def\apaciteshowurl {true}        % Muestra las url en las referencias
\def\apacitestyle {apa}        % Formato refs. apacite {apa,ieeetr,etc..}
...
\def\bibtexstyle {apa}          % Formato refs. bibtex {apa,ieeetr,etc...}
