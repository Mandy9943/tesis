...
\section{Evaluación de la calidad del agua }

\section{Modificación del sistema de control existente}

\section{Diseño del sistema de la EDI}

\section{Incorporación de la EDI al SCADA de la planta}
\subsection{Modificación de la interfaz gráfica}
\subsection{Inclusión de nuevas alarmas y condiciones de operación}

\section{Implementación y puesta en marcha}
\subsection{Etapas de la implementación}
