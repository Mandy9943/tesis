...
% \cite{carmengonzalezcasalisDisenoSistemaAutomatizado2020}
% \cite{ararDemineralizationGeothermalWater2014}
% \cite{patelChapter17Removal2022}
\bibliography{bibliografia/estado_del_arte.bib} 
% \chapter{Anexos}
